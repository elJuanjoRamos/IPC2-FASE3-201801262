    ...
    login(usuario: any) {
        ...
        this.http.post(uriUsuario, data, { headers: head })
            .subscribe(user => {
                ...
                let rol = JSON.parse(JSON.stringify(res.json())).tipo;
                //if (token) {
                ...
                if (rol === "Administrador") {
                    ...
                    this.router.navigate(['/auxiliar/dashboard/auxiliar-home']);
                } else if (rol === "Estudiante") {
                    this.router.navigate(['/estudiante/dashboard/estudiante-home']);
                }
                /*} else {
