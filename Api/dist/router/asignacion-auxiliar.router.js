...
asignacionAuxiliar.post('/asistencia', asignacion_auxiliar_controller_1.default.getInstance().createAsistencia);
asignacionAuxiliar.post('/asistenciaalumno', asignacion_auxiliar_controller_1.default.getInstance().getAsistenciaEstudiante);
